...
// The Maintenance page's Operations tab: renders whatever operations the
// backend registry returns — no slugs are hardcoded here, so new
// operations appear without UI changes.
