  ...
  if (currentUser.authenticated === true)
    return (
      <Menu as="div" className="flex-shrink mr-3">
        <Menu.Button as="button" className="bg-blue-700 hover:bg-blue-600 border border-blue-200 text-white hover:text-white px-3 py-1.5 rounded-md mr-5">
        ...
        <Menu.Items aria-labelledby="user-menu"
          ...
          <MenuItem to='/ui/changelog#new' value="New Change Log Entry" />
          <MenuItem to='/ui/project#new' value="New Project" />
        </Menu.Items>
      </Menu>
    )
  return null
