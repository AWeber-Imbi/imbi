...
import {ConfigurationSystems, CookieCutters, ProjectTypes} from ".";
    ...
    <div className="flex-auto flex flex-row">
      <Sidebar title={t("admin.title")}>
        <Sidebar.Section name={t("admin.sidebar.settings")} open={true}>
          <Sidebar.MenuItem value={t("admin.configurationSystems.collectionName")} to={`${match.path}/configuration-systems`} icon="fas box" />
          <Sidebar.MenuItem value={t("admin.cookieCutters.collectionName")} to={`${match.path}/cookie-cutters`} icon="fas cookie" />
          ...
          <Sidebar.MenuItem value={t("admin.projectTypes.collectionName")} to={`${match.path}/project-types`} icon="fas cubes" />
        </Sidebar.Section>
      ...
      <div className="flex-auto w-full p-4">
        <Route path={`${match.path}/configuration-systems`} component={ConfigurationSystems}/>
        <Route path={`${match.path}/cookie-cutters`} component={CookieCutters}/>
        <Route path={`${match.path}/project-types`} component={ProjectTypes}/>
      </div>
    </div>
  )
}
