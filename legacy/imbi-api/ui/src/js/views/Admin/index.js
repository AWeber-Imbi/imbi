    ...
    <div className="flex-auto flex flex-row">
      <Sidebar title={t("admin.title")}>
        <Sidebar.Section name={t("admin.sidebar.settings")} open={true}>
          ...
          <Sidebar.MenuItem value={t("admin.dataCenters.collectionName")} to="/ui/admin/data-centers" icon="fas building" />
          <Sidebar.MenuItem value={t("admin.deploymentTypes.collectionName")} to="/ui/admin/deployment-types" icon="fas upload" />
          <Sidebar.MenuItem value={t("admin.environments.collectionName")} to="/ui/admin/environments" icon="fas tree" />
          <Sidebar.MenuItem value={t("admin.orchestrationSystems.collectionName")} to="/ui/admin/orchestration-systems" icon="fas cogs" />
          <Sidebar.MenuItem value={t("admin.projectFactTypes.collectionName")} to="/ui/admin/project-fact-types" icon="fas ruler" />
          <Sidebar.MenuItem value={t("admin.projectLinkTypes.collectionName")} to="/ui/admin/project-link-types" icon="fas external-link-alt" />
      ...
      <div className="flex-auto w-full p-4">
        ...
        <Route path="/ui/admin/orchestration-systems" component={OrchestrationSystems}/>
        <Route path="/ui/admin/project-fact-types" component={ProjectFactTypes}/>
        <Route path="/ui/admin/project-link-types" component={ProjectLinkTypes}/>
