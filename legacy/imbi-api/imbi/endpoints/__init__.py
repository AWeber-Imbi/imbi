...
from . import (activity_feed, authentication_tokens, cookie_cutters, dashboard,
               ...
               operations_logs, permissions, project_activity_feed,
...
URLS = [
    ...
    web.url(r'^/namespaces/(?P<id>\d+)$',
            ...
            name='namespace'),
    web.url(r'^/operations-log$', operations_logs.CollectionRequestHandler),
    web.url(r'^/operations-log/(?P<id>\d+)$',
            operations_logs.RecordRequestHandler),
