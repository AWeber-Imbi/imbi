...
| `settings.py`        | Pydantic Settings classes (`Neo4j`, `Clickhouse`, `ServerConfig`, `Auth`) plus `Configuration` for TOML file loading. Settings pick up env vars with prefixes `NEO4J_`, `CLICKHOUSE_`, `IMBI_`, `IMBI_AUTH_` |
