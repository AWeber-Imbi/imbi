...
class OIDCIdentity(IdentityCapability):
    """Authorization-code + PKCE identity handler for any OIDC provider."""
        ...
        capabilities=[
            Capability(
                ...
                hints={
                    ...
                    'widget_text': 'Sign in with SSO',
                },
                handler=OIDCIdentity,
            ),
        ],
    )
