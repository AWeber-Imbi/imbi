...
class MCPManager:
    ...
    This is a stub for future implementation. When connected to
    imbi-mcp, tools will be discovered and executed via MCP.
    ...
    async def initialize(self) -> None:
        ...
        if not self._configs:
            ...
            return
        LOGGER.info(
            'MCP server support is stubbed; %d server(s) '
