...
**Implementation**:
- New module: `src/imbi.api/auth/encryption.py` with `TokenEncryption` singleton
...
**Implementation**:
- New middleware: `src/imbi.api/middleware/rate_limit.py`
...
**Implementation**:
- New endpoint module: `src/imbi.api/endpoints/api_keys.py`
...
**Implementation**:
- New endpoint module: `src/imbi.api/endpoints/mfa.py`
...
- Implement encryption utility (`src/imbi.api/auth/encryption.py`)
