...
class ProjectFactTests(base.TestCaseWithReset):
    ...
    def test_valid_fact_values(self):
        ...
        facts = [
            {
                'fact_type_id': boolean_fact['id'],
                'value': 'yes'
            },
            {
                'fact_type_id': date_fact['id'],
                'value': now.date().isoformat()
            },
            {
                'fact_type_id': decimal_fact['id'],
                'value': math.pi
            },
            {
                'fact_type_id': integer_fact['id'],
                'value': 42
            },
            {
                'fact_type_id': string_fact['id'],
                'value': 'hello world'
            },
            {
